    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            email_context = {
                ...
                "second_greeting": _(" Click on the button link below to confirm your email address and complete the registration process. You can use either your username or email address to login to the site."),
