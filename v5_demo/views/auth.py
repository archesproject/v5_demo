...
class SignupView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            email_context = {
                "button_text": _("Complete Signup for Arches Demo"),
                "link": request.build_absolute_uri(reverse("confirm_signup") + "?" + url_encrypted_userinfo),
                "greeting": _("Thanks for signing up to be a trusted user of the Arches v5 Demo Site. You will now be able to edit and add data. Soon, you will also be granted access to view and make changes within the Arches Reference Data Manager, and will be assigned a data collection project to use with Arches Collector. Check https://www.archesproject.org/demo for more details."),
                "second_greeting": _(" Click on the link below to confirm your email address and complete the signup process. You can use either your username or email address to login to the site."),
		"closing": _("This link expires in 24 hours. If you can\'t get to it before then, don\'t worry, you can always try again with the same email address."),
            ...
            msg = EmailMultiAlternatives(_("Welcome to the Arches v5 Demo Site!"), text_content, admin_email, [form.cleaned_data["email"]], bcc=["archesmailbox@gmail.com"])
